...
[![Codemagic build status](https://api.codemagic.io/apps/release-workflow/<workflow-id>/status_badge.svg)](https://codemagic.io/apps/release-workflow/<workflow-id>/latest_build)
